...
public class ReservaFamiliarDTO extends ReservaDTO {
     ...
     */
    public ReservaFamiliarDTO(int idUsuario, Date fechaHora, int duracionMinutos, String idPista, float precio, float descuento, int numeroAdultos, int numeroNinos) {
